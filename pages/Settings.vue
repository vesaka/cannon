<template>
    <div >
        <tabs refs="tabs" class="flex w-full text-blue-600">
            ...
            <tab :title="i18n('pages.settings.tabs.models.title')" :class="tabClass">
                Objects Settings
            </tab>
        </tabs>
    </div>
...
<script>
    ...
    export default {
        ...
        components: {Tab, Tabs, SystemSettings},
        computed: {
            tabOptons() {
                return { useUrlFragment: false };
            },
            tabClass() {
                return {
                    'text-red-600': true,
