import GameMatter from '$lib/game/core/2d/game-matter';
import { Texture, Container, TilingSprite } from 'pixi.js';
import { Bounds, Vertices, Runner } from 'matter-js';

import { main as mainEvents, game } from '$lib/game/cannon/config/events';
...
class CannonGame extends GameMatter {
    ...
    constructor(options) {
        ...
        console.log(this.options.ui.style);
